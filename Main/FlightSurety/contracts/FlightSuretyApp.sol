...
// SafeMath is no longer necessary since solidity ^0.8.0
...
contract FlightSuretyApp {
    ...
    FlightSuretyData public flightSurety;
    ...
    */
    constructor(address dataContract) {
        ...
        flightSurety = FlightSuretyData(dataContract);
    }
    ...
    */
    function registerAirline(address newAirline) external {
      flightSurety.registerAirline(newAirline);
    }
...
contract FlightSuretyData {
  function registerAirline(address newAirline) external {}
  function buy(address airline, string memory flight, uint256 timestamp) external {}
